...
command which help you to read csr file
note:`-noout -text`

Using both options together ensures that:

1. You see only the decoded, human-readable details (`-text`).
2. The base64-encoded CSR block is suppressed (`-noout`).
