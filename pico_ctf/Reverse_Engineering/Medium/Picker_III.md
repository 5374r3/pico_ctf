...
Can you figure out how this program works to get the flag? Connect to the program with netcat: `$ nc saturn.picoctf.net 56989` The program's source code can be downloaded [here](https://artifacts.picoctf.net/c/525/picker-III.py).
...
<function read_variable at 0x7fd942ad3920>
==> filter_value
Did not understand "filter_value" Have you tried "help"?
==> write_variable
Did not understand "write_variable" Have you tried "help"?
==> win
